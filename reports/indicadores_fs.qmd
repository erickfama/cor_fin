...
$$
\text{Revenue per capita} = \text{Total revenues / Population}
$$

$$
\begin{aligned}
\text{Total general fund revenues from own sources} &= \frac{\text{Unassigned fund}}{\text{Total general fund sources}}\\
&= \frac{\text{impuestos + contribuciones_de_mejoras + derechos + productos + aprovechamientos}}{\text{impuestos + contribuciones_de_mejoras + derechos + productos + aprovechamientos + participaciones_federales + aportaciones_federales_y_estatales}}\\
&= \text{cs_total_general_fund}
\end{aligned}
$$
$$
\begin[aligned]
\frac{\text{Intergovernmental revenues}}{\text{Total revenues}} &= \frac{\text{participaciones_federales + aportaciones_federales_y_estatales}}{\text{Total revenues}} &= \text{cs_intergov_revs_total_revs}
\end{aligned}
$$
